...
def main():
    if len(sys.argv) != 3:
        ...
        sys.stderr.write("\tpython train_xgboost.py preprocessed-dir-path model-dir-path\n")
        sys.exit(1)
    ...
    run_name = f"Train XGBoost"
    
    # Entrenar y guardar el modelo XGBoost usando los parámetros de `params.yaml`
